	...
	({ className, ...props }, ref) => {
		return (
			...
			>
				...
				<SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-action bg-surface ring-offset-surface transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" />
			</SliderPrimitive.Root>
		);
	},
);
