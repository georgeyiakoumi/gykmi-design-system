		...
		return (
			<SwitchPrimitive.Root
				...
				className={cn(
					...
					"data-[state=checked]:bg-fill-brand-strong data-[state=unchecked]:bg-border-strong",
					className,
				)}
				{...props}
			>
				<SwitchPrimitive.Thumb
					className={cn(
						"pointer-events-none block h-5 w-5 rounded-full bg-surface-base shadow-lg ring-0",
