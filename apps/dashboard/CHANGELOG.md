...
- [#38](https://github.com/georgeyiakoumi/gykmi-design-system/pull/38) [`992bda5`](https://github.com/georgeyiakoumi/gykmi-design-system/commit/992bda5a158307b1b57a948375ae9a4a2cfa6113) Thanks [@georgeyiakoumi](https://github.com/georgeyiakoumi)! - Semantic token overhaul — new theme layer from Tailwind palette.

  Replace entire token system with semantic-only colours referencing Tailwind's built-in palette. Theme layer uses color-mix() for opacity variants. Semantic layer maps to surface-_, text-_, border-_, fill-_, icon-\* categories with light/dark mode switching via [data-theme="dark"].
...
- Updated dependencies [[`992bda5`](https://github.com/georgeyiakoumi/gykmi-design-system/commit/992bda5a158307b1b57a948375ae9a4a2cfa6113)]:
  - @gykmi/ui@1.5.0
